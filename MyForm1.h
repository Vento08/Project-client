...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(524, 383);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(61, 71);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(61, 132);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(61, 211);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(279, 71);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(279, 132);
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(279, 211);
			...
			this->ClientSize = System::Drawing::Size(654, 434);
